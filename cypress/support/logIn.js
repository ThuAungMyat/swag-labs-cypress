...
const thenVerifyProductImages = () => {
    cy.get('div.inventory_list').find('img').eq(0).should('not.contain', 'jpgWithGarbageOnItToBreakTheUrl')
    cy.get('div.inventory_list').find('img').eq(1).should('not.contain', 'jpgWithGarbageOnItToBreakTheUrl')
    cy.get('div.inventory_list').find('img').eq(2).should('not.contain', 'jpgWithGarbageOnItToBreakTheUrl')
}
